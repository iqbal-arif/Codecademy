...
1.2 A Browser’s Runtime Environment
***********************************
...
1.3 The Node Runtime Environment
********************************
...
In each of these environments, different data values and functions are available, and these differences help distinguish front-end applications from back-end applications.
    ...
    1. Front-end JavaScript applications are executed in a browser’s runtime environment and have access to the window object.
    2. Back-end JavaScript applications are executed in the Node runtime environment and have access to the file system, databases, and networks attached to the server.
*/